...
class SalesManager(object):
    ...
    def getSalesItemInfo(self, billNo, type=None):
...
class PurchaseManager(object):
    ...
    def getOrderedPurchaseNoInfo():
        return _database.SalesInvoice.objects.order_by('billNo')[0].billNo

    @staticmethod
    def getPurchaseItemInfo(purchaseNo):
