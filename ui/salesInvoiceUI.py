...
# Form implementation generated from reading ui file '.\salesInvoiceUI.ui'
#
# Created: Sat Nov 24 16:34:06 2018
...
class Ui_SalesInvoice(object):
    def setupUi(self, SalesInvoice):
        ...
        self.gridLayout_6 = QtGui.QGridLayout(SalesInvoice)
        ...
        self.billDateValue.setMinimumSize(QtCore.QSize(176, 30))
        ...
        self.gridLayout_6.addWidget(self.salesInvoiceTable, 3, 0, 1, 2)
        ...
        self.performaNoValue = QtGui.QLineEdit(self.groupBox_3)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.performaNoValue.sizePolicy().hasHeightForWidth())
        self.performaNoValue.setSizePolicy(sizePolicy)
        self.performaNoValue.setMinimumSize(QtCore.QSize(150, 30))
        self.performaNoValue.setObjectName("performaNoValue")
        self.performaLayout.addWidget(self.performaNoValue)
    ...
    def retranslateUi(self, SalesInvoice):
        ...
        self.performaNoValue.setPlaceholderText(QtGui.QApplication.translate("SalesInvoice", "Enter Performa No", None, QtGui.QApplication.UnicodeUTF8))
